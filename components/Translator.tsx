  ...
  return (
    <div className="pb-32 space-y-8 font-['Hind_Siliguri'] animate-in slide-in-from-right-4 duration-500">
      <header className="flex items-center space-x-4 py-4">
        ...
        <div>
          <h2 className="text-3xl font-black dark:text-white tracking-tight">সাঈদ এআই অনুবাদক ✨</h2>
      ...
      {!result && !loading && (
        <div className="grid grid-cols-2 gap-3 mb-4">
          {['আপনি কেমন আছেন?', 'I love learning', 'সাফল্য পরিশ্রমের ফল', 'আমি ইংরেজিতে ভালো হতে চায়', ' আমি আভার মাকে আমার প্রাণের চেয়েও বেশি ভালোবাসি', 'আমি পড়াশোনা করে একজন ভালো মানুষ হিসেবে গড়ে উঠতে চাই'].map(t => (
      ...
      <div className="bg-slate-50 dark:bg-slate-900/50 rounded-[2.5rem] p-7 border dark:border-slate-800 shadow-inner">
        ...
        <textarea 
          ...
          placeholder="এখানে আপনার বাক্য লিখুন..."
