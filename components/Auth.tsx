  ...
  const syncUserProfile = async (firebaseUser: FirebaseUser) => {
    try {
      ...
      if (userSnap.exists()) {
        ...
        // Fixed: Provided department and college properties to satisfy AppUser interface
        userData = {
          uid: firebaseUser.uid,
          email: firebaseUser.email || '',
          name: cloudData.name || firebaseUser.displayName || 'শিক্ষার্থী',
          department: cloudData.department || 'হিসাববিজ্ঞান',
          college: cloudData.college || 'হাটহাজারী কলেজ',
          isPremium: true,
        ...
        // Fixed: Provided default academic values for new user profiles
        userData = {
          uid: firebaseUser.uid,
          email: firebaseUser.email || '',
