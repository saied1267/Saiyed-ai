...
const handleDownloadPDF = async (messageText: string) => {
    ...
    // ফিক্স ১: ফন্ট সাইজ এবং অপাসিটি বাড়ানো হয়েছে যাতে পিডিএফ এ স্পষ্ট দেখা যায়
    const watermarkSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="400" height="400"><text x="200" y="200" fill="rgba(0,0,0,0.09)" font-size="22" font-family="sans-serif" font-weight="bold" transform="rotate(-45 200 200)" text-anchor="middle">Kaisir ahamed Saiyed (Saiyed aI)</text></svg>`;
    
    // ফিক্স ২: Base64 এর বদলে সরাসরি UTF-8 এনকোডিং ব্যবহার করা হয়েছে
    const watermarkUrl = \`data:image/svg+xml;utf8,\${encodeURIComponent(watermarkSvg)}\`;

    const htmlContent = \`
      <div style="padding: 30px; background-color: #ffffff; font-family: 'Hind Siliguri', sans-serif; background-image: url('\${watermarkUrl}'); background-repeat: repeat; min-height: 100%;">
